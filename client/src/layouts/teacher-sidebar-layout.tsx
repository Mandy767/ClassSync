...
const TeacherSidebarLayout = () => {
    ...
    const menuItems = [
        ...
        { path: '/teacher/add-assignments', icon: <Book className="h-5 w-5" />, label: 'Add Assignments' },
        { path: '/teacher/all-assignments', icon: <Book className="h-5 w-5" />, label: 'All Assignments' },
